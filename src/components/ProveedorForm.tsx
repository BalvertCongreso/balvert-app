...
import type { ProveedorInput } from "@/types/database";

const camposNumericos = new Set(["coste_acordado", "coste_real_pagado"]);

function valoresIniciales(): Record<string, string> {
  const valores: Record<string, string> = {};
  for (const seccion of seccionesProveedor) {
...
interface Props {
  ...
  guardando: boolean;
  onGuardar: (datos: ProveedorInput) => void;
  textoBoton: string;
}
...
export default function ProveedorForm({
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    onGuardar(datos as unknown as ProveedorInput);
  }
